    ...
    return Container(
      ...
      child: Column(
        children: [
          // Chart with arrows
          SizedBox(
            height: MediaQuery.of(context).size.height / 3.6, // Adjust height dynamically
            child: Stack(
              children: [
                LineChart(
                  LineChartData(
                    ...
                    lineBarsData: [
                      _buildLine([6, 8, 9, 10, 9, 10, 11], const Color(0xFF00CFFF)),
                      _buildLine([8, 9, 10, 11, 11, 11, 13], const Color(0xFFB266FF)),
                      _buildLine([8, 9, 10, 11, 12, 12, 14], const Color(0xFFFF5DE0)),
                      _buildLine([9, 6, 6, 6, 6, 3, 3], const Color(0xFFE00B5D)),
                      _buildLine([4, 3, 3, 5, 7, 8, 6], const Color(0xFFFF9500)),
                      _buildLine([5, 6, 7, 7, 8, 8, 9], const Color(0xFFFFD60A)),
                      _buildLine([12, 11, 9, 9, 8, 7, 4], const Color(0xFF34C759)),
                    ],
                  ),
                ),
